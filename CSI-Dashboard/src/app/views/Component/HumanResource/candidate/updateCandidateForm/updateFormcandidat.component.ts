...
import { updateFormService } from './updateFormcandidat.service';


@Component({
  selector: 'app-basic-form',
  templateUrl: './updateFormcandidat.component.html',
  styleUrls: ['./updateFormcandidat.component.css'],
...
//////////////Ajout Candidat///////////////
 ...
 constructor(private _formBuilder: FormBuilder,
  ...
  private router:Router,
   ...
   {  this.countries = this.updateFormService.getCountries();
  ...
  ngOnInit() {
    ...
    this.itemForm.get("country").valueChanges.subscribe((country) => {
      ...
      if (country) {
        this.states = this.updateFormService.getStatesByCountry(country);
  ...
  saveCandidate(): void {
    ...
    if (this.myForm.valid) {
      ...
      this.updateFormService.addItem(this.myForm.value).subscribe({
        next: (res) => {
...
handleRemoveRepeatForm(index: number) {
  ...
  onCountryChange(countryShotName: string) {
    this.states = this.updateFormService.getStatesByCountry(countryShotName);
  }
}
